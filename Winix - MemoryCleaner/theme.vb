...
Public Class WinixTHEMEUserTextBox
    Inherits Control

#Region "Declarations"
    Private State As MouseState = MouseState.None
    Private WithEvents TB As TextBox
    Private _BaseColour As Color = Color.FromArgb(1, 6, 28)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
#End Region
...
#Region "Draw Control"
    Sub New()
        ...
        TB = New TextBox
        TB.Height = 190
        TB.Font = New Font("Century Gothic", 11)
        TB.Text = Text
        TB.BackColor = Color.FromArgb(9, 13, 58)
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillPath(New SolidBrush(Color.FromArgb(9, 13, 58)), GP)
            .DrawPath(New Pen(New SolidBrush(Color.FromArgb(255, 255, 255)), 2), GP)
            .FillPie(New SolidBrush(FindForm.BackColor), New Rectangle(Width - 25, Height - 23, Height + 25, Height + 25), 180, 90)
            .DrawPie(New Pen(Color.FromArgb(255, 255, 255), 2), New Rectangle(Width - 25, Height - 23, Height + 25, Height + 25), 180, 90)
        End With
        MyBase.OnPaint(e)
        G.Dispose()
...
<DefaultEvent("TextChanged")>
Public Class WinixTHEMEPassTextBox
    Inherits Control
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .DrawPie(New Pen(Color.FromArgb(255, 255, 255), 2), New Rectangle(Width - 25, Height - 60, Height + 25, Height + 25), 90, 90)
...
Public Class WinixTHEMELogButton
    Inherits Control
...
#Region "Declarations"
    ...
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _HoverColour As Color = Color.FromArgb(1, 3, 47)
    Private _PressedColour As Color = Color.FromArgb(0, 145, 184)
    Private _NormalColour As Color = Color.FromArgb(9, 13, 58)
#End Region
...
Public Class WinixTHEMECheckBox
    Inherits Control
...
#Region "Declarations"
    ...
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _BackColour As Color = Color.FromArgb(9, 13, 58)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
#End Region
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            Select Case State
                Case MouseState.Over
                    .FillRectangle(New SolidBrush(Color.FromArgb(9, 13, 58)), Base)
                    .DrawRectangle(New Pen(_BorderColour), New Rectangle(1, 1, 18, 18))
            End Select
            If Checked Then
...
Public Class WinixTHEMENormalTextBox
    Inherits Control

#Region "Declarations"
    Private State As MouseState = MouseState.None
    Private WithEvents TB As TextBox
    Private _BaseColour As Color = Color.FromArgb(9, 13, 58)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
        ...
        With G
            ...
            Select Case _Style
                ...
                Case Styles.NotRounded
                    .FillRectangle(New SolidBrush(Color.FromArgb(9, 13, 58)), New Rectangle(0, 0, Width - 1, Height - 1))
                    .DrawRectangle(New Pen(New SolidBrush(Color.FromArgb(255, 255, 255)), 2), New Rectangle(0, 0, Width, Height))
            End Select
...
Public Class WinixTHEMERadialProgressBar
    Inherits Control

#Region "Declarations"
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _BaseColour As Color = Color.FromArgb(9, 13, 58)
    Private _ProgressColour As Color = Color.FromArgb(231, 76, 60)
...
<DefaultEvent("CheckedChanged")>
Public Class WinixTHEMERadioButton
    Inherits Control

#Region "Declarations"
    Private _Checked As Boolean
    Private State As MouseState = MouseState.None
    Private _HoverColour As Color = Color.FromArgb(9, 13, 58)
    Private _CheckedColour As Color = Color.FromArgb(173, 173, 174)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _BackColour As Color = Color.FromArgb(9, 13, 58)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
...
#Region "Colour & Other Properties"
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is WinixTHEMERadioButton Then
                DirectCast(C, WinixTHEMERadioButton).Checked = False
                Invalidate()
            End If
        Next
    End Sub
...
Public Class WinixTHEMEButtonWithProgress
    Inherits Control
...
#Region "Declarations"
    ...
    Private _FontColour As Color = Color.FromArgb(255, 255, 255)
    Private _MainColour As Color = Color.FromArgb(9, 13, 58)
    Private _HoverColour As Color = Color.FromArgb(1, 3, 47)
    Private _PressedColour As Color = Color.FromArgb(9, 13, 58)
...
Public Class WinixTHEMEGroupBox
    Inherits ContainerControl

#Region "Declarations"
    Private _MainColour As Color = Color.FromArgb(9, 13, 58)
    Private _HeaderColour As Color = Color.FromArgb(9, 13, 58)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
#End Region
...
Public Class WinixTHEMESeperator
    Inherits Control

#Region "Declarations"
    Private _SeperatorColour As Color = Color.FromArgb(255, 255, 255)
...
Public Class WinixTHEMENumeric
    Inherits Control
...
#Region "Variables"
    ...
    Private _BaseColour As Color = Color.FromArgb(9, 13, 58)
    Private _ButtonColour As Color = Color.FromArgb(9, 13, 58)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _SecondBorderColour As Color = Color.FromArgb(231, 76, 60)
    Private _FontColour As Color = Color.FromArgb(255, 255, 255)
...
Public Class WinixTHEMEColourTable
    Inherits ProfessionalColorTable

#Region "Declarations"

    Private _BackColour As Color = Color.FromArgb(9, 13, 58)
    'bordercolor do context menu
    Private _BorderColour As Color = Color.FromArgb(0, 9, 86)
    Private _SelectedColour As Color = Color.FromArgb(9, 13, 58)
...
Public Class WinixTHEMEListBox
    Inherits Control
...
#Region "Variables"
    ...
    Private _ListBaseColour As Color = Color.FromArgb(9, 13, 58)
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
...
Public Class WinixTHEMETitledListBox
    Inherits Control
...
Public Class WinixTHEMEContextMenu
    Inherits ContextMenuStrip

#Region "Declarations"

    Private _FontColour As Color = Color.FromArgb(0, 1, 15)
...
#Region "Draw Control"
    ...
    Sub New()
        Renderer = New ToolStripProfessionalRenderer(New WinixTHEMEColourTable())
...
Public Class WinixTHEMEProgressBar
    Inherits Control

#Region "Declarations"
    Private _ProgressColour As Color = Color.FromArgb(9, 13, 58)
    Private _BorderColour As Color = Color.Transparent()
    Private _BaseColour As Color = Color.FromArgb(105, 108, 135)
    Private _FontColour As Color = Color.FromArgb(50, 50, 50)
    Private _SecondColour As Color = Color.FromArgb(9, 13, 58)
    Private _Value As Integer = 0
    Private _Maximum As Integer = 100
...
Public Class WinixTHEMERichTextBox
    Inherits Control
...
Public Class WinixTHEMEStatusBar
    Inherits Control
...
Public Class WinixTHEMEOnOffSwitch
    Inherits Control
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        End If
        If _Toggled = Toggles.Toggled Then
            G.DrawString("ON", New Font("Century Gothic", 11, FontStyle.Bold), New SolidBrush(_TextColour), New Rectangle(2, -1, Width - 20 + 20 / 3, Height), New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Center})
            G.DrawString("OFF", New Font("Century Gothic", 11, FontStyle.Bold), New SolidBrush(_NonToggledTextColour), New Rectangle(20 - 20 / 3 - 6, -1, Width - 20 + 20 / 3, Height), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
        ElseIf _Toggled = Toggles.NotToggled Then
            G.DrawString("OFF", New Font("Century Gothic", 11, FontStyle.Bold), New SolidBrush(_TextColour), New Rectangle(20 - 20 / 3 - 6, -1, Width - 20 + 20 / 3, Height), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
            G.DrawString("ON", New Font("Century Gothic", 11, FontStyle.Bold), New SolidBrush(_NonToggledTextColour), New Rectangle(2, -1, Width - 20 + 20 / 3, Height), New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Center})
        End If
...
Public Class WinixTHEMEComboBox
    Inherits ComboBox
...
#Region "Declarations"
    ...
    Private _SqaureColour As Color = Color.FromArgb(9, 13, 58)
    Private _ArrowColour As Color = Color.FromArgb(30, 30, 30)
    Private _SqaureHoverColour As Color = Color.FromArgb(9, 13, 58)
    Private State As MouseState = MouseState.None
#End Region
...
Public Class WinixTHEMETabControl
    Inherits TabControl
...
#Region "Declarations"
    ...
    Private _BaseColour As Color = Color.FromArgb(255, 255, 255)
    Private _ActiveColour As Color = Color.FromArgb(9, 13, 58)
    Private _BorderColour As Color = Color.FromArgb(30, 30, 30)
    Private _UpLineColour As Color = Color.FromArgb(9, 13, 58)
...
Public Class WinixTHEMETrackBar
    Inherits Control
...
#Region "Declaration"
    ...
    Private _TextColour As Color = Color.FromArgb(255, 255, 255)
    Private _BorderColour As Color = Color.FromArgb(255, 255, 255)
    Private _BarBaseColour As Color = Color.FromArgb(9, 13, 58)
    Private _StripColour As Color = Color.FromArgb(9, 13, 58)
...
<DefaultEvent("Scroll")>
Public Class WinixTHEMEVerticalScrollBar
    Inherits Control
...
#Region "Declarations"
    ...
    Private _ThumbBorder As Color = Color.FromArgb(255, 255, 255)
    Private _LineColour As Color = Color.FromArgb(23, 119, 151)
    ...
    Private _SecondBorder As Color = Color.FromArgb(255, 255, 255)
...
<DefaultEvent("Scroll")>
Public Class WinixTHEMEHorizontalScrollBar
    Inherits Control
